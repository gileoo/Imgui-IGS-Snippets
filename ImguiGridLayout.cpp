        ...
        int border ) const
{
    ...
    ImGui::SetNextWindowPos ( ImVec2( c1.x + border, c1.y + border + menu_height_ ) );
    ImGui::SetNextWindowSize( ImVec2( c2.x - c1.x - border, c2.y - c1.y - border) ); 
}

void GridLayout::resize( const ImVec2& screen_size )
{
